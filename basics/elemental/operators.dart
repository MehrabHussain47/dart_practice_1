main(){
  ...
  print(b <= 23);
  print(b >= 24);
  print(a > 30 && b < 30);  // true && true = true / false && true = false
  print(a < 30 && b > 30);  // false && false = false
  print(a < 30 || b < 30);  // true or true = true / false or true = true / false or false = false
